...
def change_colors(choice):
	customtkinter.set_default_color_theme(choice) # ne fonctionne pas
...
# pour changer de theme, mais la technique utilisé dans la fonction change_colors ne fonctionne pas
