...
# Scale Window
customtkinter.set_window_scaling(1.5) # pour changer la taille de la fenetre en multipliant ça taille
                                      # (definis par root.geometry('700x550')) par un coefficient de
                                      # proportionalité ici 1.5
# Scale Widgets
customtkinter.set_widget_scaling(0.5) # pour changer la taille des widgets de la fenetre en multipliant leurs taille
                                      # par un coefficient de proportionalité ici 0.5
