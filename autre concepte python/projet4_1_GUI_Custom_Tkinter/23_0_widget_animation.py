...
def up():
	...
	if my_y >= 195:
		...
		root.after(5, up) # pour dire de réexecuter cette fonction << up >> après 5 millisecondes
...
def down():
	...
	if my_y <= 750:
		my_text.place(x=700/2, y=my_y, anchor='center')
		up_button.configure(text=my_y)
		root.after(5, down) # pour dire de réexecuter cette fonction << down >> après 5 millisecondes
